 ...
 * @author USUARIO
 */
public class iniciarses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Hola admin, digite sus datos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(iniciarses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new iniciarses().setVisible(true);
            }
        });
    }
